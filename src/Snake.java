...
public class Snake {
   ...
   public boolean moveJoints() {
      ...
      Location newHeadLoc = new Location(currHeadLoc.getRow() + currDirection.returnRPlus(),
            currHeadLoc.getCol() + currDirection.returnCPlus());
   ...
   private void eat() {
      if (onFood) {
         ...
         Location bLoc = new Location(lastJoint.getLocation().getRow() - currDirection.returnRPlus(),
               lastJoint.getLocation().getCol() - currDirection.returnCPlus());
         if(grid.isValid(bLoc))
